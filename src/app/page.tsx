...
export default function Home() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      const sections = ['hero', 'products', 'process', 'capabilities', 'testimonials', 'contact']
  ...
  const kpis = [
    { label: 'FPY Rate', value: '98.7%', icon: TrendingUp },
    { label: 'RMA Rate', value: '0.38%', icon: Shield },
    { label: 'NPI Projects', value: '47/year', icon: Package },
    { label: 'Monthly Capacity', value: '2.5M units', icon: Factory }
  ]
