...
interface Remote433PageContentProps {
  breadcrumbItems: BreadcrumbItem[]
}

export function Remote433PageContent({ breadcrumbItems }: Remote433PageContentProps) {
  ...
  return (
    <>
        ...
        <article className="grid gap-10 md:grid-cols-2">
          ...
          <div>
            ...
            <p className="mt-4 text-slate-600">
              Compact ABS housing with custom key layout, rolling and fixed code firmware options, optional matched receiver
              module, and full certification support.
            </p>
      ...
      <RfqModal open={isRfqOpen} onClose={closeRfqModal} onSubmit={handleRfqSubmit} source={rfqSource} />
    </>
  )
}
